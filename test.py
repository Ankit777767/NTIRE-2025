...
#     elif model_id == 25:
#         # HAT
#         from models.team25_DAT.DAT import DAT
#         name, data_range = f"{model_id:25}_DAT", 1.0
...
# Import the main function from io.py
from models.team25_DAT.io import main as dat_main
...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        model_path = os.path.join('model_zoo', 'team25_DAT.pth')
        model_func = dat_main  # Use the main function from io.py
    else:
        raise NotImplementedError(f"Model {model_id} is not implemented.")
